(custom-set-variables
 ...
 '(org-agenda-files
   '("~/Nextcloud/bibliography/notes.org" "~/Nextcloud/org/todo.org"
     "~/Nextcloud/org/gcal.org"))
 '(safe-local-variable-values
   '((TeX-engine . xetex) (TeX-master . "main") (TeX-master . t)
     (eval add-hook 'yaml-mode-hook '(lambda nil (ansible 1) nil t))
     (blacken-skip-string-normalization . t) (blacken-allow-py36 . t)
     (blacken-line-length . 100) (TeX-master \` `main)
     (TeX-command-extra-options . "-shell-escape") (TeX-master . main)
     (eval when
     ...
     (lsp-python-ms-extra-paths vector
                                "/home/truls/uni/teaching/algdat-tdt4120/inginious-installed")
     ...
     (sh-indent-for-case-alt . +) (sh-indent-for-case-label . 0)
     (lexical-scoping . t) (nameless-current-name . "biblio")
     (haskell-stylish-on-save) (eval bibtex-set-dialect 'biblatex)))
